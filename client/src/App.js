  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/" element={<MainLayout hamburger={hamburger} setHamburger={setHamburger} />}>
          <Route index element={<ArticlePage hamburger={hamburger} />} />
          <Route path="/myArticle" element={<MyArticle setHamburger={setHamburger} hamburger={hamburger} />} />
        ...
        <Route path="/updateArticleForm/:id" element={<UpdateArticleForm />} />
